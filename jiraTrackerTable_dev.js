...
var theApp = {
    ...
    initRequirementFrame : async function(){
        let loadList = [
            // ------------------- 依赖jquery和jquery-ui
            "http://127.0.0.1:8887/jquery-2.2.4.min.js",
            "http://127.0.0.1:8887/jquery-ui.min.js",
            // ------------------- 依赖w2ui------------------
            "http://127.0.0.1:8887/w2ui_v1.5_modify.min.js?q=1",
            "http://127.0.0.1:8887/w2ui-1.5.min.css",
            //-------- chart.js，用于chart的绘制，目前必须用2.9版本的，因为chartlabel这个js还没适配V3以上的chart.js--
            "http://127.0.0.1:8887/Chart.min.js",
            "http://127.0.0.1:8887/chartjs-plugin-datalabels.min.js",
            "http://127.0.0.1:8887/Chart.min.css",
            // ------------------- 加载 Select2，用于筛选器 ------------------
            "http://127.0.0.1:8887/select2.min.js",
            "http://127.0.0.1:8887/select2.min.css",
            //-------- 加载 contextMenu，用于控件菜单--------------
            "http://127.0.0.1:8887/contextMenu.min.js",
            "http://127.0.0.1:8887/contextMenu.min.css",
            //-------- 加载 pinyin，用于拼音过滤 -------------
            "http://127.0.0.1:8887/pinyin_dict_notone.js",
            "http://127.0.0.1:8887/pinyinUtil.js",
            //
            "http://127.0.0.1:8887/JiraBI_dev.js?q=7",
        ];
    ...
    initRequirementReportFrame : async function(){
        let loadList = [
            ...
            "http://127.0.0.1:8887/JiraReport_dev.js",
        ];
