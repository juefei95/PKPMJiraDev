...
var theApp = {
    ...
    initRequirementFrame : async function(){
        let loadList = [
            // ------------------- 依赖jquery和jquery-ui
            "/resource/jquery-2.2.4.min.js",
            "/resource/jquery-ui.min.js",
            // ------------------- 依赖w2ui------------------
            "/resource/w2ui_v1.5_modify.min.js",
            "/resource/w2ui-1.5.min.css",
            //-------- chart.js，用于chart的绘制，目前必须用2.9版本的，因为chartlabel这个js还没适配V3以上的chart.js--
            "/resource/Chart.min.js",
            "/resource/chartjs-plugin-datalabels.min.js",
            "/resource/Chart.min.css",
            // ------------------- 加载 Select2，用于筛选器 ------------------
            "/resource/select2.min.js",
            "/resource/select2.min.css",
            //-------- 加载 contextMenu，用于控件菜单--------------
            "/resource/contextMenu.min.js",
            "/resource/contextMenu.min.css",
            //-------- 加载 pinyin，用于拼音过滤 -------------
            "/resource/pinyin_dict_notone.js",
            "/resource/pinyinUtil.js",
            //
            "/JiraBI.js?q=1",
        ];
    ...
    initRequirementReportFrame : async function(){
        let loadList = [
            ...
            "/resource/jquery-ui.min.js",
            // ------------------- 依赖w2ui------------------
            "/resource/w2ui_v1.5_modify.min.js?q=1",
            "/resource/w2ui-1.5.min.css",
            //-------- chart.js，用于chart的绘制，目前必须用2.9版本的，因为chartlabel这个js还没适配V3以上的chart.js--
            "/resource/Chart.min.js",
            "/resource/Chart.min.css",
    ...
    initFrame : async function(modelName, newTabTitle, loadList){
        try{
            ...
            for (const s of loadList) {
                await theApp._addPageDepends(w, window.location.origin + s);
            }
            w.theApp.initFrame();
        }catch{
            alert('初始化失败');
